...
<body>
    <div class="container">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light" style="padding: 0;margin-bottom: 10px;">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/doc-sach') }}"><i class="fas fa-book"></i>Sách
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form autocomplete="off" class="form-inline my-2 my-lg-0" action="{{ url('tim-kiem') }}"
                    ...
                    <input class="form-control mr-sm-2" id="keywords" type="search" name="tukhoa"
        ...
        <footer class="container my-5">
            <!-- Footer -->
            <footer class="text-center text-white" style="background-color: #107495;">
                <!-- Grid container -->
                <div class="container">
                    <!-- Section: Links -->
                    <section class="mt-5">
